...
/*
    ...
    The "slave_select" input determines which slave interface is connected to
    the master interface

*/

module axi_mux # (parameter DW=512, AW=64)
(
...
//=============================================================================
assign S0_AXI_AWREADY = (slave_select) ? 0             : M_AXI_AWREADY;
assign S1_AXI_AWREADY = (slave_select) ? M_AXI_AWREADY : 0;

assign S0_AXI_WREADY  = (slave_select) ? 0             : M_AXI_WREADY;
assign S1_AXI_WREADY  = (slave_select) ? M_AXI_WREADY  : 0;

assign S0_AXI_BVALID  = (slave_select) ? 0             : M_AXI_BVALID;
assign S1_AXI_BVALID  = (slave_select) ? M_AXI_BVALID  : 0;

assign S0_AXI_BRESP   = (slave_select) ? 0             : M_AXI_BRESP;
assign S1_AXI_BRESP   = (slave_select) ? M_AXI_BRESP   : 0;

assign S0_AXI_ARREADY = (slave_select) ? 0             : M_AXI_ARREADY;
assign S1_AXI_ARREADY = (slave_select) ? M_AXI_ARREADY : 0;

assign S0_AXI_RDATA   = (slave_select) ? 0             : M_AXI_RDATA;
assign S1_AXI_RDATA   = (slave_select) ? M_AXI_RDATA   : 0;

assign S0_AXI_RVALID  = (slave_select) ? 0             : M_AXI_RVALID;
assign S1_AXI_RVALID  = (slave_select) ? M_AXI_RVALID  : 0;

assign S0_AXI_RRESP   = (slave_select) ? 0             : M_AXI_RRESP;
assign S1_AXI_RRESP   = (slave_select) ? M_AXI_RRESP   : 0;

assign S0_AXI_RLAST   = (slave_select) ? 0             : M_AXI_RLAST;
assign S1_AXI_RLAST   = (slave_select) ? M_AXI_RLAST   : 0;
//=============================================================================
