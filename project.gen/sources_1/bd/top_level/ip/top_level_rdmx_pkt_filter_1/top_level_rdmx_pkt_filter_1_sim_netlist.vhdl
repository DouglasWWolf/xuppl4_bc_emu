...
--               /fpga/xuppl4_bc_emu/project.gen/sources_1/bd/top_level/ip/top_level_rdmx_pkt_filter_1/top_level_rdmx_pkt_filter_1_sim_netlist.vhdl
...
entity top_level_rdmx_pkt_filter_1_rdmx_pkt_filter is
  port (
  ...
  attribute ORIG_REF_NAME of top_level_rdmx_pkt_filter_1_rdmx_pkt_filter : entity is "rdmx_pkt_filter";
end top_level_rdmx_pkt_filter_1_rdmx_pkt_filter;

architecture STRUCTURE of top_level_rdmx_pkt_filter_1_rdmx_pkt_filter is
...
entity top_level_rdmx_pkt_filter_1 is
  ...
  attribute NotValidForBitStream of top_level_rdmx_pkt_filter_1 : entity is true;
  attribute CHECK_LICENSE_TYPE : string;
  attribute CHECK_LICENSE_TYPE of top_level_rdmx_pkt_filter_1 : entity is "top_level_rdmx_pkt_filter_1,rdmx_pkt_filter,{}";
  attribute DowngradeIPIdentifiedWarnings : string;
  attribute DowngradeIPIdentifiedWarnings of top_level_rdmx_pkt_filter_1 : entity is "yes";
  attribute IP_DEFINITION_SOURCE : string;
  attribute IP_DEFINITION_SOURCE of top_level_rdmx_pkt_filter_1 : entity is "module_ref";
  attribute X_CORE_INFO : string;
  attribute X_CORE_INFO of top_level_rdmx_pkt_filter_1 : entity is "rdmx_pkt_filter,Vivado 2021.1";
end top_level_rdmx_pkt_filter_1;

architecture STRUCTURE of top_level_rdmx_pkt_filter_1 is
  ...
  attribute X_INTERFACE_PARAMETER of AXIS_IN_TREADY : signal is "XIL_INTERFACENAME AXIS_IN, TDATA_NUM_BYTES 64, TDEST_WIDTH 0, TID_WIDTH 0, TUSER_WIDTH 0, HAS_TREADY 1, HAS_TSTRB 0, HAS_TKEEP 1, HAS_TLAST 1, FREQ_HZ 322265625, PHASE 0.0, CLK_DOMAIN top_level_cmac_0_gt_txusrclk2, LAYERED_METADATA undef, INSERT_VIP 0";
  ...
  attribute X_INTERFACE_PARAMETER of AXIS_OUT_TREADY : signal is "XIL_INTERFACENAME AXIS_OUT, TDATA_NUM_BYTES 64, TDEST_WIDTH 0, TID_WIDTH 0, TUSER_WIDTH 0, HAS_TREADY 1, HAS_TSTRB 0, HAS_TKEEP 1, HAS_TLAST 1, FREQ_HZ 322265625, PHASE 0.0, CLK_DOMAIN top_level_cmac_0_gt_txusrclk2, LAYERED_METADATA undef, INSERT_VIP 0";
  attribute X_INTERFACE_INFO of AXIS_OUT_TVALID : signal is "xilinx.com:interface:axis:1.0 AXIS_OUT TVALID";
  attribute X_INTERFACE_INFO of clk : signal is "xilinx.com:signal:clock:1.0 clk CLK";
  attribute X_INTERFACE_PARAMETER of clk : signal is "XIL_INTERFACENAME clk, ASSOCIATED_BUSIF AXIS_IN:AXIS_OUT, ASSOCIATED_RESET resetn, FREQ_HZ 322265625, FREQ_TOLERANCE_HZ 0, PHASE 0.0, CLK_DOMAIN top_level_cmac_0_gt_txusrclk2, INSERT_VIP 0";
...
inst: entity work.top_level_rdmx_pkt_filter_1_rdmx_pkt_filter
     port map (
