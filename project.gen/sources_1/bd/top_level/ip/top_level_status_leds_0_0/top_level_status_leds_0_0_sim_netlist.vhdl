...
--               /fpga/xuppl4_bc_emu/project.gen/sources_1/bd/top_level/ip/top_level_status_leds_0_0/top_level_status_leds_0_0_sim_netlist.vhdl
...
entity top_level_status_leds_0_0_status_leds is
  port (
    led_green_l : out STD_LOGIC_VECTOR ( 2 downto 0 );
    led_orange_l : in STD_LOGIC_VECTOR ( 2 downto 0 )
  );
...
architecture STRUCTURE of top_level_status_leds_0_0 is
  ...
  signal \^led_green_l\ : STD_LOGIC_VECTOR ( 3 downto 0 );
  signal \^pcie_up\ : STD_LOGIC;
...
begin
  ...
  \^qsfp0_up\ <= qsfp0_up;
  \^qsfp1_up\ <= qsfp1_up;
  led_green_l(3) <= \^led_green_l\(3);
  led_green_l(2) <= \<const1>\;
  led_green_l(1 downto 0) <= \^led_green_l\(1 downto 0);
  led_orange_l(3) <= \^pcie_up\;
...
inst: entity work.top_level_status_leds_0_0_status_leds
     port map (
      led_green_l(2) => \^led_green_l\(3),
      led_green_l(1 downto 0) => \^led_green_l\(1 downto 0),
      led_orange_l(2) => \^pcie_up\,
      led_orange_l(1) => \^qsfp1_up\,
      led_orange_l(0) => \^qsfp0_up\
    );
end STRUCTURE;
