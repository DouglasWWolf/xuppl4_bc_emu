...
proc create_hier_cell_s00_entry_pipeline { parentCell nameHier } {
  ...
  set_property -dict [ list \
   ...
   CONFIG.SEG002_BASE_ADDR {0x0000000000001000} \
   ...
   CONFIG.SEG003_BASE_ADDR {0x0000000000002000} \
   ...
   CONFIG.SEG004_BASE_ADDR {0x0000000000003000} \
   ...
   CONFIG.SEG005_BASE_ADDR {0x0000000000004000} \
   ...
   CONFIG.SEG006_BASE_ADDR {0x0000000100000000} \
