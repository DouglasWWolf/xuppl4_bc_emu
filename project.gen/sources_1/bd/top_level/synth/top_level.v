...
module mindy_core_imp_1ICMGAH
  ...
  top_level_system_ila_0_0 outgoing_ila
       (.SLOT_0_AXI_araddr(rdmx_shim_M_AXI0_ARADDR),
        .SLOT_0_AXI_arburst(rdmx_shim_M_AXI0_ARBURST),
        .SLOT_0_AXI_arcache(rdmx_shim_M_AXI0_ARCACHE),
        .SLOT_0_AXI_arid(rdmx_shim_M_AXI0_ARID),
        .SLOT_0_AXI_arlen(rdmx_shim_M_AXI0_ARLEN),
        ...
        .SLOT_0_AXI_awaddr(rdmx_shim_M_AXI0_AWADDR),
        .SLOT_0_AXI_awburst(rdmx_shim_M_AXI0_AWBURST),
        .SLOT_0_AXI_awcache(rdmx_shim_M_AXI0_AWCACHE),
        .SLOT_0_AXI_awid(rdmx_shim_M_AXI0_AWID),
        .SLOT_0_AXI_awlen(rdmx_shim_M_AXI0_AWLEN),
        ...
        .SLOT_0_AXI_bid({1'b0,1'b0,1'b0,1'b0}),
        ...
        .SLOT_0_AXI_rdata(rdmx_shim_M_AXI0_RDATA),
        .SLOT_0_AXI_rid({1'b0,1'b0,1'b0,1'b0}),
        ...
        .SLOT_1_AXI_awaddr(rdmx_shim_M_AXI1_AWADDR),
        .SLOT_1_AXI_awburst(rdmx_shim_M_AXI1_AWBURST),
        .SLOT_1_AXI_awcache(rdmx_shim_M_AXI1_AWCACHE),
        .SLOT_1_AXI_awid(rdmx_shim_M_AXI1_AWID),
        .SLOT_1_AXI_awlen(rdmx_shim_M_AXI1_AWLEN),
        ...
        .SLOT_1_AXI_rdata(rdmx_shim_M_AXI1_RDATA),
...
(* CORE_GENERATION_INFO = "top_level,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=top_level,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=50,numReposBlks=40,numNonXlnxBlks=0,numHierBlks=10,maxHierDepth=3,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=28,numPkgbdBlks=0,bdsource=USER,da_axi4_cnt=7,synth_mode=OOC_per_IP}" *) (* HW_HANDOFF = "top_level.hwdef" *) 
module top_level
   (init_clk,
    led_green_l,
    led_orange_l,
